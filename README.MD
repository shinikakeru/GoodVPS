...
6. Скачивает и настраивает fail2ban для **1024 порта**
7. Выводит текущие ключи на сервере в **/root/.ssh/authorized_keys**
8. Перезапускает службы
9. Чистит файлы за собой
